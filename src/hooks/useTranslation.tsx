...
const translations = {
  en: {
    ...
    lobbySubtitle: 'Master translation theories through interactive gamified challenges.',
    ...
    termRace: 'Term Race',
    termRaceDesc: 'Identify strategies like Omission and Modulation in a rapid quiz.',
    ...
    termStep1: 'Read the definition of a translation strategy as quickly as you can.',
    termStep2: 'Pick the correct term from the options. 3 in a row triggers a Booster!',
    termStep3: 'Correct answers are worth 10 points. Speed and streaks are key.',
  ...
  ar: {
    ...
    lobbySubtitle: 'أتقن نظريات الترجمة من خلال تحديات تفاعلية ممتعة.',
    ...
    termRace: 'سباق المصطلحات',
    termRaceDesc: 'حدد الاستراتيجيات مثل الحذف والتعديل في اختبار سريع.',
    ...
    termStep1: 'اقرأ تعريف استراتيجية الترجمة بأسرع ما يمكن.',
    termStep2: 'اختر المصطلح الصحيح من الخيارات. 3 إجابات متتالية تفعّل المعزز!',
    termStep3: 'الإجابات الصحيحة تستحق 10 نقاط. السرعة والتتابع هما المفتاح.',
